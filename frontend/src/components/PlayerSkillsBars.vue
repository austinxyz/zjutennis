      ...
      <div class="space-y-3">
        <div v-if="skills.mental !== null && skills.mental !== undefined">
          <div class="flex justify-between text-sm mb-1">
            ...
            <span class="font-medium">{{ skills.mental }}/5.5</span>
          </div>
          <div class="h-2 bg-muted rounded-full overflow-hidden">
            <div
              class="h-full bg-purple-500 transition-all"
              :style="{ width: `${(skills.mental / 5.5) * 100}%` }"
            ></div>
          </div>
        </div>
        ...
        <div v-if="skills.movement !== null && skills.movement !== undefined">
          <div class="flex justify-between text-sm mb-1">
            ...
            <span class="font-medium">{{ skills.movement }}/5.5</span>
          </div>
          <div class="h-2 bg-muted rounded-full overflow-hidden">
            <div
              class="h-full bg-purple-500 transition-all"
              :style="{ width: `${(skills.movement / 5.5) * 100}%` }"
            ></div>
          </div>
        </div>
        ...
        <div v-if="skills.fitness !== null && skills.fitness !== undefined">
          <div class="flex justify-between text-sm mb-1">
            ...
            <span class="font-medium">{{ skills.fitness }}/5.5</span>
          </div>
          <div class="h-2 bg-muted rounded-full overflow-hidden">
            <div
              class="h-full bg-purple-500 transition-all"
              :style="{ width: `${(skills.fitness / 5.5) * 100}%` }"
            ></div>
          </div>
        </div>
      </div>
      ...
      <div class="space-y-3">
        <div v-if="skills.courtPositioning !== null && skills.courtPositioning !== undefined">
          <div class="flex justify-between text-sm mb-1">
            ...
            <span class="font-medium">{{ skills.courtPositioning }}/5.5</span>
          </div>
          <div class="h-2 bg-muted rounded-full overflow-hidden">
            <div
              class="h-full bg-green-500 transition-all"
              :style="{ width: `${(skills.courtPositioning / 5.5) * 100}%` }"
            ></div>
          </div>
        </div>
        ...
        <div v-if="skills.shotSelection !== null && skills.shotSelection !== undefined">
          <div class="flex justify-between text-sm mb-1">
            ...
            <span class="font-medium">{{ skills.shotSelection }}/5.5</span>
          </div>
          <div class="h-2 bg-muted rounded-full overflow-hidden">
            <div
              class="h-full bg-green-500 transition-all"
              :style="{ width: `${(skills.shotSelection / 5.5) * 100}%` }"
            ></div>
          </div>
        </div>
        ...
        <div v-if="skills.competitiveSpirit !== null && skills.competitiveSpirit !== undefined">
          <div class="flex justify-between text-sm mb-1">
            ...
            <span class="font-medium">{{ skills.competitiveSpirit }}/5.5</span>
          </div>
          <div class="h-2 bg-muted rounded-full overflow-hidden">
            <div
              class="h-full bg-green-500 transition-all"
              :style="{ width: `${(skills.competitiveSpirit / 5.5) * 100}%` }"
            ></div>
          </div>
        </div>
      </div>
